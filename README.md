...
## 興味・関心
- 自らが愛する自社IPによる映像・コンテンツ制作に携わりたい
- 機能的で使いやすい、わかりやすいUIを作りたい
- チームのワークフローを改善したい
- 開発タイトルや技術の権利化、エンジニア目線による法務職サポート
...
- VICONを用いたモーション撮影 <br>
- 3Dキャラクターのセットアップ <br>
- 3Dキャラクターの表現向上、およびその実装 <br>

### 業務内容
自社IPのPR映像制作のため、Unity Timelineを用いた映像制作を行っています。 <br>
時節により、自社IPのコンテンツ制作を別途開発します。

<details>
<summary>職務例: 映像制作</summary>
Unity Timeline, Recorder、ブレンドシェイプツール等を用いた自社IPによる映像制作を行います。<br>
VICONでモーションアクター様の動きをキャプチャし、編集されたモーションデータを用いて映像を作成します。 <br>
キャラクター特有の表情の新規作成や、企画内容に沿った表現の再現のためシェーダーを用いることもあります。 <br>
使用ツール : Unity, VICON, MotionBuilder, Git, JetBrains Rider, ShotGridなど
</details>
<br>

<details>
<summary>職務例: コンテンツ制作</summary>
UnityおよびC#などを用いた自社IPによるコンテンツ制作を行います。 <br>
これらはビジネス的観点から時節柄やイベント開催時期を狙った企画によるもので、主にゲームであることが多いです。 <br>
使用ツール : C#, Unity, Git, JetBrains Rider, ShotGridなど
</details>
<br>
